 ...
 *
 * This navigation is shown at the end of archives to get to another page of entries.
 *
 * @since 0.2.3
 *
 * @uses genesis_get_option()            Get theme setting value.
 ...
 * @uses genesis_older_newer_posts_nav() Older and Newer links.
 */
...
/**
 * Echo post navigation in Older Posts / Newer Posts format.
 *
 * Applies `genesis_older_link_text` and `genesis_newer_link_text` filters.
 *
 * @since 0.2.2
 */
